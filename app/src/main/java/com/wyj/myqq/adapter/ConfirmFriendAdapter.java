...
public class ConfirmFriendAdapter extends BaseAdapter{
    ...
    private boolean isAccept,isRefuse;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.btnRefuse = (Button) convertView.findViewById(R.id.btn_refuse);
        ...
        if(isRefuse){
            ...
            holder.btnRefuse.setVisibility(View.GONE);
            holder.tvResult.setVisibility(View.VISIBLE);
            holder.tvResult.setText("已拒绝该申请");
        }
        ...
        holder.btnRefuse.setOnClickListener(new MyClickListener(position));
